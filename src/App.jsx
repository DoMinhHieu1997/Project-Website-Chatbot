  ...
  return (
    <>
          ...
          <div className='header-container sm:w-6xl sm:flex mx-auto px-0 sm:px-3 py-3 sm:py-10 justify-between'>
            ...
            <div className='header-content--right w-screen sm:w-auto flex flex-col justify-center'>
              <div className='flex items-center bg-blue-300 sm:bg-white mt-3 sm:mt-0 py-3 sm:py-0 justify-center sm:justify-end gap-4 sm:mb-3'>
                ...
                <button className='font-sans text-white sm:text-gray-800 font-semibold'>Đăng nhập</button>
                <button className='font-sans text-white sm:text-gray-800 font-semibold'>Đăng ký</button>
              </div>
            ...
            <ul className='font-sans font-semibold flex justify-center gap-5 text-white w-full'>
              <li>
                <a className='nav-item nav-home'>
                  <img className='w-[24px] h-[24px]' src='https://www.tlu.edu.vn/Portals/_default/skins/tluvie/images/front/home.png'></img>
                </a>
              </li>
              <li>
      ...
      <div className='pageContent'>
        ...
        <div className="home-quick-link flex justify-between gap-4">
          <a className='quick-link-item text-center py-4'>
            <img className='mb-3' src="https://www.tlu.edu.vn/portals/0/images/front/tuyen_sinh.png" alt="" />
            <div>Tuyển sinh</div>
          </a>
          <a className='quick-link-item text-center py-4'>
            <img className='mb-3' src='https://www.tlu.edu.vn/portals/0/images/front/65_64x40.png'></img>
            <div>65 Năm</div>
          </a>
          <a className='quick-link-item text-center py-4'>
            <img className='mb-3' src='https://www.tlu.edu.vn/portals/0/images/front/viec_lam.png'></img>
            <div>Thông tin việc làm</div>
          </a>
          <a className='quick-link-item text-center py-4'>
            <img className='mb-3' src='https://www.tlu.edu.vn/portals/0/images/front/quality.jpg'></img>
            <div>Đảm bảo chất lượng</div>
          </a>
          <a className='quick-link-item text-center py-4'>
            <img className='mb-3' src='https://www.tlu.edu.vn/portals/0/images/front/www.jpg'></img>
            <div>Tạp chí</div>
          </a>
          <a className='quick-link-item text-center py-4'>
            <img className='mb-3' src='https://www.tlu.edu.vn/portals/0/images/front/email.jpg'></img>
            <div>TLU Mail</div>
          </a>
          <a className='quick-link-item text-center py-4'>
            <img className='mb-3' src='https://www.tlu.edu.vn/portals/0/images/front/lichcongtac.jpg'></img>
            <div>Lịch công tác</div>
          </a>
          <a className='quick-link-item text-center py-4'>
            <img className='mb-3' src='https://www.tlu.edu.vn/portals/0/images/front/user.jpg'></img>
            <div>Đăng ký học</div>
          </a>
        </div>
      </div>
